    ...
    # ----------------------------------------
        ...
        netG = net(upscale=opt_net['upscale'],
                ...
                #    depths=opt_net['depths'],
                   ...
                   upsampler=opt_net['upsampler'],
                   resi_connection=opt_net['resi_connection'])
    elif net_type == 'swinfusionSR':
        from models.network_swinfusionSR import SwinFusionSR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
                ...
                #    depths=opt_net['depths'],
                   ...
                   upsampler=opt_net['upsampler'],
                   resi_connection=opt_net['resi_connection'],
                   contrastive=opt["train"]["weights"]["contrast"]!=0.0,
                   Ex_depths = opt_net["Ex_depths"],
                   Fusion_depths = opt_net["Fusion_depths"],
                   Re_depths = opt_net["Re_depths"],
                   Ex_num_heads = opt_net["Ex_num_heads"],
                   Fusion_num_heads = opt_net["Fusion_num_heads"],
                   Re_num_heads = opt_net["Re_num_heads"]
                   )
    elif net_type == 'MGISR':
        from models.mgisr import MGISR as net
        netG = net(opt_net)
    # ----------------------------------------
    # others
    # ----------------------------------------
